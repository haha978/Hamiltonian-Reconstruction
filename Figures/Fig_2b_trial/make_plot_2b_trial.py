...
def make_plot():
    ...
    E_hist_dep = load_l("noisy_E_hist_dep.pkl")
    ...
    #get average for dep
    E_hist_dep_avg = get_hist_avg(avg_num, E_hist_dep)
    ...
    ax.scatter(param_idx_l, E_hist_dep, alpha = 0.1, c = "#E69F00", s = 20, marker = ".")
    ax.scatter(param_idx_l_avg, E_hist_dep_avg, alpha = 1, c = "#E69F00", s = 20, marker = ".", label = "Energy (dep)")
    ...
    ax2.scatter(param_idx_l, HR_dist_hist_dep, alpha = 0.1, c = "#F0E442", s = 20, marker=".")
    ax2.scatter(param_idx_l_avg, HR_dist_hist_dep_avg, alpha = 1, c = "#F0E442", s = 20, marker=".", label = "HR distance (dep)")
    ...
    plt.savefig("plot_2b_E_fid_HR.svg", dpi = 300, bbox_inches='tight')
...
def make_plot2():
    ...
    ax.scatter(param_idx_l, HR_dist_hist_dep, alpha = 0.1, c = "#F0E442", s = 20, marker=".")
    ax.scatter(param_idx_l_avg, HR_dist_hist_dep_avg, alpha = 1, c = "#F0E442", s = 20, marker=".", label = "HR distance (dep)")
    ...
    plt.savefig("plot_2b_fid_HR.svg", dpi = 300, bbox_inches='tight')
